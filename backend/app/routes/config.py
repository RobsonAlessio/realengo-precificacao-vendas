...
@router.put("")
def put_config(body: schemas.ConfigUpdate, current_user: models.User = auth_utils.require_role("admin"), db: Session = Depends(get_db)):
    """
    ...
    """
    save_config(body.model_dump(exclude_none=True))
